                ...
                <div class="modal-dialog modal-md">
                    <div class="modal-content">
                        ...
                        <div class="modal-body" style="text-align: center; display: block;">
                            ...
                            <small class="font-bold"> Budget Edit</small><br>
                        </div>
                        ...
                        <div class="col-lg-12">
                            <form @submit.prevent="validateBeforeSubmit(payload)" id="form-section-fairs">
                                ...
                                <div class="col-lg-2 form-group padding-bottom" :class="{'has-error': errors.has(payload.years.value)}">
                                    ...
                                    <select v-bind:id="payload.years.value" @change="getWeeksList()" v-validate :data-vv-rules=payload.years.rules :data-vv-validate-on="validateForm" title="Please choose one of the following options" :name=payload.years.post  data-live-search="false" v-model=payload.years.post class="selectpicker">
                                ...
                                <div class="col-lg-1 form-group padding-bottom" :class="{'has-error': errors.has(payload.weekFrom.value)}">
                                    ...
                                    <select v-bind:id="payload.weekFrom.value" v-validate :data-vv-rules=payload.weekFrom.rules :data-vv-validate-on="validateForm" title="Please choose one of the following options" :name=payload.weekFrom.post  data-live-search="false" v-model=payload.weekFrom.post class="selectpicker">
                                ...
                                <div class="col-lg-1 form-group padding-bottom" :class="{'has-error': errors.has(payload.weekTo.value)}">
                                    ...
                                    <select v-bind:id="payload.weekTo.value" v-validate :data-vv-rules=payload.weekTo.rules :data-vv-validate-on="validateForm" title="Please choose one of the following options" :name=payload.weekTo.post  data-live-search="false" v-model=payload.weekTo.post class="selectpicker">
