                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <form @submit.prevent="validateBeforeSubmit(payload)" id="form-section-fairs">
                                ...
                                <div class="col-lg-3 form-group padding-bottom" :class="{'has-error': errors.has(payload.years.value)}">
                                ...
                                <div class="col-lg-3 form-group padding-bottom" :class="{'has-error': errors.has(payload.weekFrom.value)}">
                                    <label class="label" style="display: table-cell">{{ payload.weekFrom.label }}</label>

                                    <select v-validate :data-vv-rules=payload.weekFrom.rules :data-vv-validate-on="validateForm" title="Please choose one of the following options" :name=payload.weekFrom.post  data-live-search="true" v-model=payload.weekFrom.post class="selectpicker">
                                ...
                                <div class="col-lg-3 form-group padding-bottom" :class="{'has-error': errors.has(payload.weekTo.value)}">
                                    <label class="label" style="display: table-cell">{{ payload.weekTo.label }}</label>

                                    <select v-validate :data-vv-rules=payload.weekTo.rules :data-vv-validate-on="validateForm" title="Please choose one of the following options" :name=payload.weekTo.post  data-live-search="true" v-model=payload.weekTo.post class="selectpicker">
                                ...
                                <div class="col-lg-3 form-group padding-bottom" :class="{'has-error': errors.has(payload.brands.value)}">
    ...
    export default {
        ...
        methods: {
            ...
            yearsList (instance) {
                ...
                // Init ComboBox
                instance.comboBoxMount(payload, 'years');
            ...
            weeksList (instance) {
                ...
                // Init ComboBox
                instance.comboBoxMount(payload, 'weekFrom');
                instance.comboBoxMount(payload, 'weekTo');
