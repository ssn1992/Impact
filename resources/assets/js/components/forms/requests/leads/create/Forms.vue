...
<template>
    <div>
        <div id="forms">
            <div class="modal inmodal fade" id="modal-check" tabindex="-1" role="dialog"  aria-hidden="true" style="z-index: 209999950!important;">
                <div class="modal-dialog modal-md">
                    <div class="modal-content">
                        ...
                        <div class="modal-body" style="text-align: center; display: block;">
                            <i class="fa fa-warning fa-5x text-warning" style="display: block; padding-bottom: 15px;"></i>
                            <small class="font-bold"> {{ warningMessage }} </small><br>
                        </div>
                        <div class="text-center" style="padding-bottom: 20px;">
                            <button @click="validateBeforeSubmit('create')" type="button" class="btn btn-warning">Send Anyway</button>
                        </div>
                ...
                <div class="modal-dialog modal-md">
                    <div class="modal-content">
                        ...
                        <div class="modal-body" style="text-align: center; display: block;">
                            ...
                            <small class="font-bold"> Lead Created </small><br>
            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <form @submit.prevent="validateBeforeSubmit('check')" id="form-section-fairs">
                                ...
                                <div v-for="(data, index) in payload" v-model="payload">
                                    ...
                                    <div v-else-if="data.fieldType == 'combobox'" class="col-lg-4 form-group padding-bottom combobox" :class="{'has-error': errors.has(data.value)}">
                                ...
                                <div class="col-lg-12">
                                    <button  class="ladda-button ladda-button-selector btn btn-primary" data-style="zoom-in" leadType="submit">Add Lead
    ...
    export default {
        ...
        methods: {
            cleanForm () {
                ...
                self.payload.leadType.post  = [];
                self.payload.brand.post     = [];
                self.payload.industry.post  = [];
                self.payload.sources.post   = [];
                self.payload.category.post  = [];
                self.payload.type.post      = [];
                self.payload.subType.post   = [];
            ...
            postCreateLead (payload, check) {
                ...
                .then(function (response) {
                    ...
                    if (response.data.duplicated.flag === true) {
                        self.warningMessage = response.data.duplicated.message
                ...
                this.$nextTick(function () {
                    this.$validator.validateAll().then((result) => {
                        ...
                        if (result && stateErrors && typeErrors && subTypeErrors) {
                            ...
                            this.postCreateLead(payload, check);
            ...
            validateSourceTypeErrors () {
                ...
                if (this.payload.sources.post === 6  && (this.payload.type.post === null || this.payload.type.post === undefined) ||
                    ...
                    this.payload.sources.post === 9 && (this.payload.type.post === null || this.payload.type.post === undefined) ||
