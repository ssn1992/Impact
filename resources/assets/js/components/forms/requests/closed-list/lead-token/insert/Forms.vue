                ...
                <div class="modal-dialog modal-md">
                    <div class="modal-content">
                        ...
                        <div class="modal-body" style="text-align: center; display: block;">
                            ...
                            <small class="font-bold"> Token Lead Inserted </small><br>
                        </div>
                            ...
                            <form @submit.prevent="validateBeforeSubmit(payload)" id="form-section-fairs">
                                ...
                                <div v-for="(data, index) in payload" v-model="payload">
                                    <div v-if="data.fieldType == 'text-field'" class="form-group col-lg-6 padding-bottom" :class="{'has-error': errors.has(data.value)}">
                                        ...
                                        <input @click="getToken()" readonly v-model="data.post" :name=data.value  v-validate :data-vv-rules=data.rules :data-vv-validate-on="validateForm" class="form-control" type="text" :placeholder="data.label"/>
                                ...
                                <div class="col-lg-12">
                                    <button  class="ladda-button ladda-button-selector btn btn-primary" data-style="zoom-in" type="submit">Insert Token Lead
    ...
    export default {
        ...
        methods: {
            ...
            postInsertTokenLead(payload) {
                ...
                axios({
                    method: 'post',
                    url: 'closed-list/lead-token-insert',
                    data: payload
                })

                .then(function (response) {
                    window.closedTable.tablesRequest("table-lead-token", true);
            ...
            validateBeforeSubmit(request) {
                this.$validator.validateAll().then((result) => {
                    if (result) {
                        ...
                        this.postInsertTokenLead(payload);
            ...
            getToken () {
                ...
                this.payload.tokenLead.post = token;
            },
        },
        mounted() {
            // Get Brand List
