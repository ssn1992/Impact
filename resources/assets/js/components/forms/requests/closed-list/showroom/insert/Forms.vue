                ...
                <div class="modal-dialog modal-md">
                    <div class="modal-content">
                        ...
                        <div class="modal-body" style="text-align: center; display: block;">
                            ...
                            <small class="font-bold"> Showroom Inserted </small><br>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <form @submit.prevent="validateBeforeSubmit(payload)" id="form-section-fairs">
                                ...
                                <div class="col-lg-12">
                                    <button  class="ladda-button ladda-button-selector btn btn-primary" data-style="zoom-in" type="submit">Insert Showroom
    ...
    export default {
        ...
        methods: {
            ...
            postInsertShowroom(payload) {
                ...
                axios({
                    method: 'post',
                    url: 'closed-list/showroom-insert',
                    data: payload
                })

                .then(function (response) {
                    window.closedTable.tablesRequest("table-showroom", true);
            ...
            validateBeforeSubmit(request) {
                this.$validator.validateAll().then((result) => {
                    if (result) {
                        ...
                        this.postInsertShowroom(payload);
