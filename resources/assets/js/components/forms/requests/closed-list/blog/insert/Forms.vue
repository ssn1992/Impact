                ...
                <div class="modal-dialog modal-md">
                    <div class="modal-content">
                        ...
                        <div class="modal-body" style="text-align: center; display: block;">
                            ...
                            <small class="font-bold"> Blog Inserted </small><br>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <form @submit.prevent="validateBeforeSubmit(payload)" id="form-section-fairs">
                                ...
                                <div class="col-lg-12">
                                    <button  class="ladda-button ladda-button-selector btn btn-primary" data-style="zoom-in" type="submit">Insert Blog
    ...
    export default {
        ...
        methods: {
            ...
            postInsertBlog(payload) {
                ...
                axios({
                    method: 'post',
                    url: 'closed-list/blog-insert',
                    data: payload
                })

                    .then(function (response) {
                        window.closedTable.tablesRequest("table-blog", true);
            ...
            getBlogCategoryList (instance) {
                ...
                axios({
                    ...
                    .then(function (response) {
                        // Init ComboBox
                        instance.comboBoxMount(response.data.blogCategory, 'blogCategory');
            ...
            getLevelList (instance) {
                ...
                axios({
                    ...
                    .then(function (response) {
                        // Init ComboBox
                        instance.comboBoxMount(response.data.level, 'level');
        ...
        mounted() {
            ...
            this.getBlogCategoryList(this);

            // Get Level List
            this.getLevelList(this);
        }
    }
</script>
