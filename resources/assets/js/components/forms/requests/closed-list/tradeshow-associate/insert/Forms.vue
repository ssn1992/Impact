                        ...
                        <div class="col-lg-12">
                            <form @submit.prevent="validateBeforeSubmit(payload)" id="form-section-fairs">
                                ...
                                <div v-for="(data, index) in payload" v-model="payload">
                                    ...
                                    <div v-else-if="data.fieldType == 'bool'" class="col-lg-6 ">
                                        <div class="form-group">
                                            <label class="label" style="display: table-cell">{{ payload.active.label }}</label>

                                            <div class="switch" style="padding-top: 8px;">
                                                <div class="onoffswitch">
                                                    <input v-model="payload.active.post" type="checkbox" name="acitvemenu" class="onoffswitch-checkbox" id="acitvemenu">
                                                    <label class="onoffswitch-label" for="acitvemenu">
                                ...
                                <div class="col-lg-12">
                                    <button  class="ladda-button ladda-button-selector btn btn-primary" data-style="zoom-in" type="submit">Associate Tradeshow
    ...
    export default {
            ...
            return {
                ...
                payload: {
                    ...
                    tradeshowEdition : {
                        disabled: false,
                        fieldType: 'combobox',
                        label: 'Tradeshow Edition',
                        value: 'tradeshowEdition',
                        rules : 'required',
                        post: null,
                        data: [],
                    },
        ...
        methods: {
            ...
            posAssociateTradeshow(payload) {
                ...
                axios({
                    method: 'post',
                    url: 'closed-list/tradeshow-associate-insert',
                    data: payload
                })
            ...
            validateBeforeSubmit(request) {
                this.$validator.validateAll().then((result) => {
                    if (result) {
                        ...
                        this.posAssociateTradeshow(payload);
            ...
            getTradeshowList (instance) {
                // Send a POST request
                axios({
                    method: 'get',
                    url: 'get-tradeshow-list',
                })

                .then(function (response) {
                    // Init ComboBox
                    instance.comboBoxMount(response.data.tradeshows, 'tradeshow');
            ...
            getTradeshowEditionList (instance) {
                // Send a POST request
                axios({
                    method: 'get',
                    url: 'get-tradeshow-edition-list',
                })

                .then(function (response) {
                    // Init ComboBox
                    instance.comboBoxMount(response.data.tradeshows, 'tradeshowEdition');
            ...
            getTradeshowTimeList (instance) {
                // Send a POST request
                axios({
                    method: 'get',
                    url: 'get-tradeshow-time-list',
                })

                .then(function (response) {
                    // Init ComboBox
                    instance.comboBoxMount(response.data.tradeshows, 'tradeshowTime');
        ...
        mounted() {
            // Get Tradeshow List
            this.getTradeshowList(this);

            // Get Tradeshow Edition List
            this.getTradeshowEditionList(this);

            // Get Tradeshow Time List
            this.getTradeshowTimeList(this);
