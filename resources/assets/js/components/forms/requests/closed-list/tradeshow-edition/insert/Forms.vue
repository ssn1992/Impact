        ...
        <div id="forms">
                ...
                <div class="modal-dialog modal-md">
                    <div class="modal-content">
                        ...
                        <div class="modal-body" style="text-align: center; display: block;">
                            ...
                            <small class="font-bold"> Tradeshow edition Inserted </small><br>
                        </div>
            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5> Insert Tradeshow edition</h5>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <form @submit.prevent="validateBeforeSubmit(payload)" id="form-section-fairs">
                                ...
                                <div class="col-lg-12">
                                    <button  class="ladda-button ladda-button-selector btn btn-primary" data-style="zoom-in" type="submit">Insert Tradeshow edition
    ...
    export default {
        ...
        methods: {
            ...
            postInsertForm(payload) {
                ...
                axios({
                    method: 'post',
                    url: 'closed-list/tradeshow-edition-insert',
                    data: payload
                })

                .then(function (response) {
                    window.closedTable.tablesRequest("table-tradeshow-edition", true);
