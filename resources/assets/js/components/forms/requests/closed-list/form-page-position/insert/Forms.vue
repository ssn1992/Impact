        ...
        <div id="forms">
                ...
                <div class="modal-dialog modal-md">
                    <div class="modal-content">
                        ...
                        <div class="modal-body" style="text-align: center; display: block;">
                            ...
                            <small class="font-bold"> Form Page Position Inserted </small><br>
                        </div>
            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5> Insert Form Position Page</h5>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <form @submit.prevent="validateBeforeSubmit(payload)" id="form-section-fairs">
                                ...
                                <div class="col-lg-12">
                                    <button  class="ladda-button ladda-button-selector btn btn-primary" data-style="zoom-in" type="submit">Insert Form Page Position
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            postInsertFormPagePosition(payload) {
                ...
                axios({
                    method: 'post',
                    url: 'closed-list/form-page-position-insert',
                    data: payload
                })

                    .then(function (response) {
                        window.closedTable.tablesRequest("table-form-page-position", true);
            ...
            validateBeforeSubmit(request) {
                this.$validator.validateAll().then((result) => {
                    if (result) {
                        ...
                        this.postInsertFormPagePosition(payload);
