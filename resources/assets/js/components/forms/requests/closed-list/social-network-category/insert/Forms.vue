        ...
        <div id="forms">
                ...
                <div class="modal-dialog modal-md">
                    <div class="modal-content">
                        ...
                        <div class="modal-body" style="text-align: center; display: block;">
                            ...
                            <small class="font-bold"> Social Network Category Inserted </small><br>
                        </div>
            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5> Insert Social Network Category</h5>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <form @submit.prevent="validateBeforeSubmit(payload)" id="form-section-fairs">
                                ...
                                <div class="col-lg-12">
                                    <button  class="ladda-button ladda-button-selector btn btn-primary" data-style="zoom-in" type="submit">Insert Social Network Category
    ...
    export default {
        ...
        methods: {
            ...
            postInsertSocialNetwork(payload) {
                ...
                axios({
                    method: 'post',
                    url: 'closed-list/social-network-category-insert',
                    data: payload
                })

                .then(function (response) {
                    window.closedTable.tablesRequest("table-social-network-category", true);
