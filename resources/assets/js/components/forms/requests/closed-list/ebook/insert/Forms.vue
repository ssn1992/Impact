                ...
                <div class="modal-dialog modal-md">
                    <div class="modal-content">
                        ...
                        <div class="modal-body" style="text-align: center; display: block;">
                            ...
                            <small class="font-bold"> Ebook Inserted </small><br>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <form @submit.prevent="validateBeforeSubmit(payload)" id="form-section-fairs">
                                ...
                                <div class="col-lg-12">
                                    <button  class="ladda-button ladda-button-selector btn btn-primary" data-style="zoom-in" type="submit">Insert Ebook
    ...
    export default {
        ...
        methods: {
            ...
            postInsertEbook(payload) {
                ...
                axios({
                    method: 'post',
                    url: 'closed-list/ebook-insert',
                    data: payload
                })

                .then(function (response) {
                    window.closedTable.tablesRequest("table-ebook", true);
            ...
            getEbooksCategory (instance) {
                // Send a POST request
                axios({
                    method: 'get',
                    url: 'get-ebook-category',
                })

                .then(function (response) {
                    // Init ComboBox
                    instance.comboBoxMount(response.data.ebookCategory, 'cat');
        ...
        mounted() {
            ...
            // Get Brands Access list
            this.getEbooksCategory(this);
        }
    }
</script>
