        ...
        <div v-bind:id='graphId'>
            ...
            <div class="ibox float-e-margins ">
                ...
                <div class="ibox-content">
                    ...
                    <line-chart :height="325" :lineData="LineDataYears"></line-chart>
                </div>
            </div>
            <div v-if="!empty && !isInit" class="ibox float-e-margins ">
                ...
                <div class="ibox-content">
                    <bar-chart :height="325" :barData="barDataBrands"></bar-chart>
                </div>
            </div>
        </div>
    </div>
        ...
        methods: {
            ...
            updateData(isUpdate = false, response) {
                ...
                if (response.data == null) {
                    ...
                    // Fill Line Chart Data
                    this.LineDataYears     = {
                        labels: response.data.dataSetYears.labels,
                        steppedLine: true,
                        datasets: [
                            {
                                label: response.data.dataSetYears.label,
                                backgroundColor: [
                                    'rgba(75, 192, 192, 0.2)'
                                ],
                                borderColor: [
                                ...
                                borderWidth: 1,
                                data: response.data.dataSetYears.data,
                            }
                        ]
                    }
                    ...
                    // Fill Line Chart Data
                    this.barDataBrands     = {
                        labels: response.data.dataSetBrands.labels,
                        steppedLine: true,
                        datasets: [
                            {
                                label: response.data.dataSetBrands.label,
                                backgroundColor: [
                                    'rgba(75, 192, 192, 0.2)',
                                    'rgba(255, 99, 132, 0.2)',
                                    'rgba(54, 162, 235, 0.2)',
                                ...
                                borderWidth: 1,
                                data: response.data.dataSetBrands.data,
                            }
                        ]
                    }
                }
            ...
            updateDataWithError(isUpdate = false, response, error) {
                ...
                // Fill Bar Chart Data Years
                this.LineDataYears     = {
                    labels: [],
                    datasets: []
                }

                // Fill Bar Chart Data Brands
                this.barDataBrands     = {
                    labels: [],
                    datasets: []
                }
