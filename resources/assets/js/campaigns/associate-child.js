 ...
 * @private
 */
var _requestForms = ["associate-child"];

/**
 * Form Component instance
 */
const formComponent = require('../components/forms/requests/campaigns/associate-child/forms');
...
var _requestTour = (
    {
        tourName: 'tour-leads-create-table',
...
this.start = function() {
    if(!_isInit) {
        console.log("Campaings Associate Child Area started..");
