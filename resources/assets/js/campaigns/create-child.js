 ...
 * @private
 */
var _requestForms = ["create-child"];

/**
 * Form Component instance
 */
const formComponent = require('../components/forms/requests/campaigns/create-child/forms');
...
this.start = function() {
    if(!_isInit) {
        console.log("Campaings Create Child Area started..");
