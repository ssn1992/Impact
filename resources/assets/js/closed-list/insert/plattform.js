 ...
 * @private
 */
var _requestForms = ["insert-plattform"];
 ...
 * @private
 */
var _requestTables = ["table-plattform"];
 ...
 */
const insertClosedListComponent = require('../../components/forms/requests/closed-list/plattform/insert/forms');
...
this.start = function() {
    if(!_isInit) {
        console.log("Closed List Area Plattform Insert Area started..");
