 ...
 */
const insertClosedListComponent = require('../../components/forms/requests/closed-list/cta/insert/forms');
...
this.start = function() {
    if(!_isInit) {
        console.log("Closed List Area Cta Insert Area started..");
