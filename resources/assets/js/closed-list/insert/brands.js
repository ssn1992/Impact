 ...
 * @private
 */
var _requestForms = ["insert-brands"];

/**
 * Form Component instance
 */
const insertClosedListComponent = require('../../components/forms/requests/closed-list/brands/insert/forms');
 ...
 * @private
 */
var _requestTables = ["table-brands"];
...
this.start = function() {
    if(!_isInit) {
        console.log("Closed List Area Brands Insert Area started..");
