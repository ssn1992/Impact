 ...
 * @private
 */
var _requestForms = ["insert-website"];
 ...
 * @private
 */
var _requestTables = ["table-website"];
 ...
 */
const insertClosedListComponent = require('../../components/forms/requests/closed-list/website/insert/forms');
...
this.start = function() {
    if(!_isInit) {
        console.log("Closed List Area Website Insert Area started..");
