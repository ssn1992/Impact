 ...
 * @private
 */
var _requestForms = ["insert-cta-color"];
 ...
 * @private
 */
var _requestTables = ["table-cta-color"];
 ...
 */
const insertClosedListComponent = require('../../components/forms/requests/closed-list/cta-color/insert/forms');
...
this.start = function() {
    if(!_isInit) {
        console.log("Closed List Area Cta Color Insert Area started..");
