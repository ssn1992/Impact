 ...
 * @private
 */
var _requestForms = ["insert-email"];
 ...
 * @private
 */
var _requestTables = ["table-email"];
 ...
 */
const insertClosedListComponent = require('../../components/forms/requests/closed-list/email/insert/forms');
...
this.start = function() {
    if(!_isInit) {
        console.log("Closed List Area Email Insert Area started..");
