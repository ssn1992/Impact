 ...
 * @private
 */
var _requestForms = ["insert-form-page"];
 ...
 * @private
 */
var _requestTables = ["table-form-page"];
 ...
 */
const insertClosedListComponent = require('../../components/forms/requests/closed-list/form-page/insert/forms');
...
this.start = function() {
    if(!_isInit) {
        console.log("Closed List Area Form Page Insert Area started..");
