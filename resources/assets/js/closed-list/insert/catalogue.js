 ...
 * @private
 */
var _requestForms = ["insert-catalogue"];
 ...
 * @private
 */
var _requestTables = ["table-catalogue"];
 ...
 */
const insertClosedListComponent = require('../../components/forms/requests/closed-list/catalogue/insert/forms');
...
this.start = function() {
    if(!_isInit) {
        console.log("Closed List Area Catalogue Insert Area started..");
