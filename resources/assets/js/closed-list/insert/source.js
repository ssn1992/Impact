 ...
 * @private
 */
var _requestForms = ["insert-source"];
 ...
 * @private
 */
var _requestTables = ["table-source"];
 ...
 */
const insertClosedListComponent = require('../../components/forms/requests/closed-list/source/insert/forms');
...
this.start = function() {
    if(!_isInit) {
        console.log("Closed List Area Source Insert Area started..");
