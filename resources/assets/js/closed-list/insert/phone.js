 ...
 * @private
 */
var _requestForms = ["insert-phone"];
 ...
 * @private
 */
var _requestTables = ["table-phone"];
 ...
 */
const insertClosedListComponent = require('../../components/forms/requests/closed-list/phone/insert/forms');
...
this.start = function() {
    if(!_isInit) {
        console.log("Closed List Area Phone Insert Area started..");
