 ...
 * @private
 */
var _requestForms = ["insert-level"];
 ...
 * @private
 */
var _requestTables = ["table-level"];
 ...
 */
const insertClosedListComponent = require('../../components/forms/requests/closed-list/level/insert/forms');
...
this.start = function() {
    if(!_isInit) {
        console.log("Closed List Area Level Insert Area started..");
