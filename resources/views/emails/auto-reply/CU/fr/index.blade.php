                            ...
                            <div style="background-color: transparent; width: 100% !important;">
                                <!--[if (!mso)&(!IE)]><!--><div style="border-top: 0px solid transparent; border-left: 0px solid transparent; border-bottom: 0px solid transparent; border-right: 0px solid transparent; padding-top:5px; padding-bottom:5px; padding-right: 0px; padding-left: 0px;"><!--<![endif]-->
                                    ...
                                    <div align="center" class="img-container center  autowidth  fullwidth" style="padding-right: 0px;  padding-left: 0px;">
                                        ...
                                        <a href="http://www.circu.net/news/events/2018/jan-maison-et-objet-paris-2018?utm_source=automatic-response-MO18&amp;utm_medium=automatic-response&amp;utm_content=maison-jan-2018&amp;utm_campaign=automatic-response" target="_blank">
                                            <img class="center  autowidth  fullwidth" align="center" border="0" src="{{asset('images/email/auto-reply/CU/newsletter-diaria-french.jpg')}}" alt="Image" title="Image" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: block !important;border: none;height: auto;float: none;width: 100%;max-width: 500px" width="500">
                                        </a>
